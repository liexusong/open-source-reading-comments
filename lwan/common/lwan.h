...
struct lwan_module_t_ {
    ...
    void *(*init)(void *args);                  // init callback
    void *(*init_from_hash)(const struct hash *hash);
    void (*shutdown)(void *data);               // shutdown callback
    lwan_http_status_t (*handle)(lwan_request_t *request,
        lwan_response_t *response, void *data); // module's handler
